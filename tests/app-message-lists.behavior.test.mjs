...
const page=core.parsePage({messages:[{id:'msg_1',body:'hidden',deliverAt:'2026-08-01T12:00:00Z',awaitingAt:null,status:'scheduled',source:'inbound',origin:'inbound',version:1},{id:'msg_2',body:'self hidden',deliverAt:'2026-08-02T12:00:00Z',awaitingAt:'2026-07-20T12:00:00Z',status:'scheduled',source:'discord_self',origin:'local',version:2},{id:'msg_3',deliverAt:'2026-08-03T12:00:00Z',awaitingAt:null,status:'scheduled',source:'website',origin:'local',version:1}],hasMore:false,nextCursor:null,serverTime:'2026-07-20T12:00:00Z'});
